...
public class Shuffle extends UniversalActor  {
	...
	public UniversalActor construct (MapReduce mr, int theid) {
		Object[] __arguments = { mr, new Integer(theid) };
	...
	public class State extends UniversalActor .State {
		...
		HashMap dict;
		int myID;
		public void construct(MapReduce mr, int theid){
			kernel = mr;
			dict = new HashMap();
			myID = theid;
		}
		public HashMap shuffle(Object[] v) {
			{
				...
				{
					Object _arguments[] = { "Received Shuffle Command" };
			...
			{
				// standardOutput<-println("Returning Dictionary")
				{
					Object _arguments[] = { "Returning Dictionary" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
